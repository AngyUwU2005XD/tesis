...
@NgModule({
  declarations: [
    ...
    Juegotres2Component,
    Juegotres3Component,
    Juegocuatro1Component,
    Juegocuatro2Component,
    Juegocuatro3Component,
    Juegocinco1Component,
    Juegocinco2Component,
    Juegocinco3Component,
    Juegoseis1Component,
    Juegoseis2Component,
    Juegoseis3Component,
    Juegosiete1Component,
    Juegosiete2Component,
    Juegosiete3Component,
    Juegoocho1Component,
    Juegoocho2Component,
    Juegoocho3Component,
    Juegonueve1Component,
    Juegonueve2Component,
    Juegonueve3Component,
    Juegodos4Component,
    InicioComponent,
    MenujuegosComponent,
    ModalComponent,
